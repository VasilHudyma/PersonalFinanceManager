...
public class TransactionDtoMapper {
    ...
    public TransactionDto transactionToTransactionDto(Transaction transaction) {
        return new TransactionDto(transaction.getId(), transaction.getCategoryId(), transaction.getOperationId(),
    ...
    public Transaction transactionDtoToTransaction(TransactionDto transactionDto) {
        return new Transaction(transactionDto.getId(), transactionDto.getCategoryId(), transactionDto.getOperationId(),
                transactionDto.getSum(), transactionDto.getDescription(), transactionDto.getCreatedDate(), transactionDto.getUpdatedDate());
    }
}
